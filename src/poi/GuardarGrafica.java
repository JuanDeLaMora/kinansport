    ...
    public BufferedImage creaImagen()
    {
        ...
        XYDataset juegoDatos= new XYSeriesCollection(series);
                ...
                XYDataset         el conjunto de datos X y Y del tipo XYDataset (aqui cambian el parametro
                                  ...
                                  en la documentacion aqui <a href="http://www.jfree.org/jfreechart/api/javadoc/index.html" title="http://www.jfree.org/jfreechart/api/javadoc/index.html">http://www.jfree.org/jfreechart/api/javadoc/index.html</a>                              iremos notando los cambios mas adelante..
        ...
        ************************************************
        ...
        try 
        {  
                ChartUtilities.saveChartAsJPEG(new File("NombreGrafica.jpg"), chart, 500, 300);
        } catch (IOException e) {
